        ...
        <template x-teleport="body">
            ...
            >
                ...
                <div style="position: absolute; inset: 0; display: flex; align-items: center; justify-content: center; padding: 1rem; pointer-events: none;">
                    {{-- Dialog Panel --}}
                    <div
                        style="position: relative; background: white; border-radius: 0.75rem; box-shadow: 0 20px 25px -5px rgba(0,0,0,0.1), 0 8px 10px -6px rgba(0,0,0,0.1); padding: 1.5rem; max-width: 28rem; width: 100%; pointer-events: auto;"
                        x-transition:enter="transition ease-out duration-200"
