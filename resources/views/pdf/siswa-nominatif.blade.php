...
<body>
    ...
    <h2 style="text-transform: uppercase;">DAFTAR NOMINATIF SISWA {{ strtoupper($sekolah?->nama ?? '') }}</h2>
    ...
    <table style="width: 100%; border: none !important; margin-top: 30px; font-size: 10pt; background: transparent !important;">
        <tr style="background: transparent !important;">
            ...
            <td style="border: none !important; width: 40%; text-align: left; background: transparent !important; padding: 0;">
