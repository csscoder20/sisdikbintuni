...
<head>
    ...
    <style>
        ...
        th { background-color: #f2f2f2; color: #000; text-align: center; font-weight: bold; }
        ...
        .header p { margin: 2px 0; font-size: 12px; font-weight: bold; text-transform: uppercase; }
        .header-logo-left { position: absolute; left: 0; top: 0; height: 60px; }
        .header-logo-right { position: absolute; right: 0; top: 0; height: 60px; }
        
        .document-title { text-align: center; font-size: 14px; font-weight: bold; text-decoration: underline; margin-bottom: 20px; text-transform: uppercase; }
    </style>
</head>
<body>
    <div class="header">
